...
save_dir = '/OLIVINE/data/output/PARTICLE/Amodal/oryx/model_B/'
sand_name = 'Venice'
experiment_name = 'Venice_3-part_collect_amodal_144fps'
percent_values = [0.01, 0.05, 0.1, 0.16, 0.2, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.8, 0.84, 0.9, 0.95, 0.99]

d1 = load_json_data(f'/OLIVINE/data/output/PARTICLE/Amodal/oryx/model_B/Venice/Venice_part_1_144fps/coco_formatted.json')
d2 = load_json_data(f'/OLIVINE/data/output/PARTICLE/Amodal/oryx/model_B/Venice/Venice_part_2_144fps/coco_formatted.json')
d3 = load_json_data(f'/OLIVINE/data/output/PARTICLE/Amodal/oryx/model_B/Venice/Venice_part_3_144fps/coco_formatted.json')
...
df = df_sorted.iloc[50:] # excludes largest volume particles, usually these are outliers. 
