...
save_dir='/projects/OLIVINE/data/output/PARTICLE/synth/test_B_500_synth'
coco_json='/projects/OLIVINE/data/synthetic_data/particle_test_B_500/particle_test_B_500.json'
echo "Pixel Ratio: "$pixel_2_mm
echo "save_dir: "$save_dir

source /projects/OLIVINE/environments/SAM-grain/bin/activate

python3 -m analyze_synth_grain --save_dir $save_dir --coco_json $coco_json --pixel2mm $pixel_2_mm
