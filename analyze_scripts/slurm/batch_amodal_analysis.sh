...
declare -a jobs=(
  "triton_part_1_144fps Triton model_B"
  "triton_part_2_144fps Triton model_B"
  "triton_part_3_144fps Triton model_B"
)
...
SAVE_DIR="/path/to/your/data/$MODEL/$EXP/"
PRED_DIR="/path/to/your/data/$MODEL/$EXP/$MODEL"
